                            ...
                            <div class="container col-lg-7">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Volunteer Application Form</h1>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="number" name="cell" maxlength="10" class="form-control form-control-user"
                                                ...
                                                <div class="small" id="errorMessage" style="color:red; display: none;"><p>Maximum length must be 10</p></div>
                                        </div>
